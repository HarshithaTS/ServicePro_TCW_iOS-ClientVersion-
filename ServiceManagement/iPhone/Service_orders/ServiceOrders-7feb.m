    ...
    if (IS_IPHONE) {
      ...
      /*  UILabel *lbl1 = (UILabel *)[cell viewWithTag:T_TEXT1_TAG];
       ...
       /* UILabel *lbl2 = (UILabel *)[cell viewWithTag:T_TEXT2_TAG];
        ...
        [self Create_Label_Service_Order:cell andTag:T_TEXT2IP_TAG andFontS:Font_Size andNOLines:5 andLdata:tmpStr];
...
-(void) createStatusButtonImage:(NSMutableDictionary *) _marray
{
    ...
    Est_Arrival = [NSString stringWithFormat: @"%@ %@", [_marray objectForKey:@"ZZETADATE"],[[_marray objectForKey:@"ZZETATIME"] stringByReplacingOccurrencesOfString:@":00" withString:@""]];
