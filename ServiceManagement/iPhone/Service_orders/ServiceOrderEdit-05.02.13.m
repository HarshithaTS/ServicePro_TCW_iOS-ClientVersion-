...
-(void)EstimatedArrival_DataExchange:(NSString *)data
{
    ...
    else
    {
        ...
        [objServiceManagementData.taskDataDictionary setObject:@"0000-00-00" forKey:@"ZZETADATE"];
        [estimatedArrival.view removeFromSuperview];
...
- (void)viewDidLoad
{
    ...
    if ([[objServiceManagementData.taskDataDictionary objectForKey:@"STATUS"] isEqualToString:@"ACPT"] ) {
        [objServiceManagementData.taskDataDictionary setObject:[objCurrentDateTime convertShortDateToStringFormat:[objServiceManagementData.taskDataDictionary objectForKey:@"ZZETADATE"]] forKey:@"ZZETADATE"];
    }   
    ...
    objectForKey:[[objServiceManagementData.taskListArray objectAtIndex:
    objServiceManagementData.editTaskId] objectForKey:@"STATUS"]] forKey:@"STATUS"];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if([[objServiceManagementData.taskDataDictionary objectForKey:@"STATUS"] isEqualToString:@"Rejected"] && (indexPath.row == (16-total_arrayc) || indexPath.row == 6))
        rowHeight = 115.0f;
    else if([[objServiceManagementData.taskDataDictionary objectForKey:@"STATUS"] isEqualToString:@"Rejected"] && indexPath.row == 8)
        rowHeight = 115.0f;
        ...
        rowHeight = 115.0f;
    else if(!([[objServiceManagementData.taskDataDictionary objectForKey:@"STATUS"]  isEqualToString:@"Accepted"]) && !([[objServiceManagementData.taskDataDictionary objectForKey:@"STATUS"] isEqualToString:@"Rejected"]) && indexPath.row == (14-total_arrayc))
        rowHeight = 115.0f;
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
	...
	if([[objServiceManagementData.taskDataDictionary objectForKey:@"STATUS"] isEqualToString:@"Rejected"]) 
	{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(![[objServiceManagementData.taskDataDictionary objectForKey:@"ZZETADATE"] isEqualToString:@"0000-00-00"]) {
        ...
        /*NSLog(@"####################################################################################################");
        NSLog(@"##############");
        NSLog(@"Date is :::::::: %@ ",[objServiceManagementData.taskDataDictionary objectForKey:@"ZZETADATE"]);
        NSLog(@"Time is :::::::: %@",[objServiceManagementData.taskDataDictionary objectForKey:@"ZZETATIME"]);
        NSLog(@"##############");
        NSLog(@"####################################################################################################");
        */
        ...
        strETA1 = [objCurrentDateTime currentdate];
	...
	if(indexPath.section == 0)
	{
        ...
        if([[objServiceManagementData.taskDataDictionary objectForKey:@"STATUS"] isEqualToString:@"Rejected"]) 
        {
            ...
            switch (indexPath.row) {
                ...
                case 5: {
//                    commonLabel = [Design LabelFormationWithColor:5.0 :5.0 :140.0 :[self labelHeightCalculation:NSLocalizedString(@"Edit_Task_Label_Select_a_Reason",@""):1]:16.0f :1];
                    //biren's CODE GOES HERE
...
//                    CGRect frame2 = CGRectMake(163, 5.0, 155.0, 35.0);
                ...
                case 6: {
                   ...
                   // commonLabel = [Design LabelFormationWithColor:5.0 :5.0 :140.0 :[self labelHeightCalculation:NSLocalizedString(@"Edit_Task_Label_Enter_the_Reason",@""):1]:16.0f :1];
                     //biren's CODE GOES HERE
            ...
            switch (indexPath.row) {
                ...
                case 6: {
					commonLabel = [Design LabelFormationWithColor:5.0 :5.0 :140.0 :[self labelHeightCalculation:NSLocalizedString(@"Edit_Task_Label_Estimated",@""):1]:16.0f :1];
        ...
        if (flag == 0)
        {
			...
			switch (total_count) {
                case 0:
                    ...
                    CGRect rectView= CGRectMake(4, 2, self.view.frame.size.width-10, 41);
                    ...
                    UILabel *lblHeader1 = [[[UILabel alloc] init]autorelease];
                    lblHeader1 = [Design LabelFormationWithColor:2.0 :0.0 :_framewidth-20 :35:16.0f :1];
                    ...
                    UILabel *lblHeader2 = [[[UILabel alloc] init]autorelease];
                    lblHeader2 = [Design LabelFormationWithColor:2.0 :32.0 :_framewidth-20 :25:16.0f :1];
                    ...
                    UILabel *lblHeader3 = [[[UILabel alloc] init]autorelease];
                    lblHeader3 = [Design LabelFormationWithColor:2.0 :56.0 :_framewidth-20 :25:16.0f :1];
                    ...
                    UILabel *lblHeader4 = [[[UILabel alloc] init]autorelease];
                    lblHeader4 = [Design LabelFormationWithColor:2.0 :77.0 :_framewidth-20 :25:16.0f :1];
                ...
                case 1:
                    ...
                    commonLabel = [Design LabelFormationWithColor:163.0 :5.0 :_framewidth-20 :[self labelHeightCalculation:[objServiceManagementData.taskDataDictionary objectForKey:@"OBJECT_ID"]:2]:15.0f :2];	
                ...
                case 2:
                    ...
                    commonLabel = [Design LabelFormationWithColor:163.0 :5.0 :_framewidth-20 :[self labelHeightCalculation:[objServiceManagementData.taskDataDictionary objectForKey:@"PROCESS_TYPE"]:2]:15.0f :2];
                ...
                case 3:
                    ...
                    commonLabel = [Design LabelFormationWithColor:163.0 :5.0 :_framewidth-20 :[self labelHeightCalculation:[objServiceManagementData.taskDataDictionary objectForKey:@"PRIORITY"]:2]:15.0f :2];	
                ...
                case 4:     
                    ...
                    commonLabel = [Design LabelFormationWithColor:5.0 :5.0 :140.0 :[self labelHeightCalculation:NSLocalizedString(@"Edit_Task_Label_Status",@""):1]:16.0f :1];	
                ...
                case 5:
                    ...
                    commonLabel = [Design LabelFormation:163.0 :5.0 :_framewidth-20 :[self labelHeightCalculation:[objServiceManagementData.taskDataDictionary objectForKey:@"ZZKEYDATE"]:2]:15.0f :2];
               ...
               /* case 6:  temporary comment this row by selvan on 30/01/2013
                ...
                case 6:
                    ...
                    taskNotes = [Design textViewFormation:163.0 :5.0 :_framewidth-160  :97.0 :2 :self];
                ...
                case 7:
                    ...
                    if([[TableTitle objectAtIndex:0] isEqualToString:@"Other Details"]) 
                    {
                        ...
                        cell.userInteractionEnabled = FALSE;
                        [cell.contentView addSubview:headerView2];
                        [headerView2 autorelease];
                        ...
                        commonLabel = [Design LabelFormationWithColor:163.0 :5.0 :_framewidth-20 :[self labelHeightCalculation:[objServiceManagementData.taskDataDictionary objectForKey:[TableData objectAtIndex:0]]:2]:15.0f :2];	
                ...
                case 8:
                    ...
                    if([[TableTitle objectAtIndex:1] isEqualToString:@"Other Details"]) 
                    {
                       ...
                       /* commonLabel = [Design LabelFormationWithColor:163.0 :5.0 :_framewidth-20 :[self labelHeightCalculation:[objServiceManagementData.taskDataDictionary objectForKey:[TableData objectAtIndex:1]]:2]:15.0f :2];
                        ...
                        //Create view for Header text display
                        CGRect rectView= CGRectMake(163.0,5.0, self.view.frame.size.width-10, 41);
                       ...
                       // customView.layer.borderColor = [UIColor clearColor];
                        ...
                        UILabel *lblValue = [[[UILabel alloc] init]autorelease];
                        lblValue = [Design LabelFormationWithColor:2.0 :0.0 :100.0 :35:16.0f :1];
                        ...
                        telButton.frame = CGRectMake(110.0, 2.0, 30, 30);
                ...
                case 10:
                    ...
                    if([[TableTitle objectAtIndex:3] isEqualToString:@"Other Details"]) 
                    {
                        ...
                        commonLabel = [Design LabelFormationWithColor:163.0 :5.0 :_framewidth-20 :[self labelHeightCalculation:[objServiceManagementData.taskDataDictionary objectForKey:[TableData objectAtIndex:3]]:2]:15.0f :2];	
                ...
                case 11:
                    ...
                    if([[TableTitle objectAtIndex:4] isEqualToString:@"Other Details"]) 
                    {
                        ...
                        commonLabel = [Design LabelFormationWithColor:163.0 :5.0 :_framewidth-20 :[self labelHeightCalculation:[objServiceManagementData.taskDataDictionary objectForKey:[TableData objectAtIndex:4]]:2]:15.0f :2];	
                ...
                case 12:
                    ...
                    if([[TableTitle objectAtIndex:5] isEqualToString:@"Other Details"]) 
                    {
                        ...
                        commonLabel = [Design LabelFormationWithColor:163.0 :5.0 :_framewidth-20 :[self labelHeightCalculation:[objServiceManagementData.taskDataDictionary objectForKey:[TableData objectAtIndex:5]]:2]:15.0f :2];	
                ...
                case 13:
                    ...
                    if([[TableTitle objectAtIndex:6] isEqualToString:@"Other Details"]) 
                    {
                       ...
                       /* displayTask = [self DisplayTextView:displayTask];
                        ...
                        commonLabel = [Design LabelFormationWithColor:163.0 :5.0 :_framewidth-20 :[self labelHeightCalculation:[objServiceManagementData.taskDataDictionary objectForKey:[TableData objectAtIndex:6]]:2]:15.0f :2];	
...
-(void)createDetailContent {
    //Create view for Header text display
    CGRect rectView= CGRectMake(4, 2, self.view.frame.size.width-10, 41);
    headerView2 = [[UIView alloc] initWithFrame:rectView];
    ...
    //Display Header line one and two
    UILabel *lblHeader11 = [[[UILabel alloc] init]autorelease];
    ...
    UILabel *lblHeader12 = [[[UILabel alloc] init]autorelease];
    ...
    UILabel *lblHeader13 = [[[UILabel alloc] init]autorelease];
    ...
    UILabel *lblHeader14 = [[[UILabel alloc] init]autorelease];
...
-(void) updateServiceOrder{
    ...
    */
    ...
    if([[objServiceManagementData.taskDataDictionary objectForKey:@"STATUS"] isEqualToString:@"Accepted"])
        ...
        statusStr = @"WAIT";
    else if([[objServiceManagementData.taskDataDictionary objectForKey:@"STATUS"] isEqualToString:@"Rejected"])
        statusStr = @"RJCT";
    ...
    else if(statusStr == @"RJCT")
    {
        strPar5 = [NSString stringWithFormat:@"ZGSXSMST_SRVCDCMNT21[.]%@[.]%@[.]%@[.]%@[.]%@[.]%@[.]%@[.][.]",
                   ...
                   [objCurrentDateTime convertMMMDDformattoyyyMMdd:[objServiceManagementData.taskDataDictionary objectForKey:@"ZZKEYDATE"]],
                   statusStr,
                   [objServiceManagementData.taskDataDictionary objectForKey:@"STATUS_REASON"],
                   [objServiceManagementData.taskDataDictionary objectForKey:@"TIMEZONE_FROM"],
                   [objServiceManagementData.taskDataDictionary objectForKey:@"ZZFIELDNOTE"]
                   ];
    ...
    if([CheckedNetwork connectedToNetwork]) // checking for internet connection in Device
    {
        ...
        if ( ![responseValue isEqualToString:@"555-Success"] ){
            ...
            //[objServiceManagementData fetchAndUpdateTaskList:[NSString stringWithFormat:@"SELECT * FROM '%@' WHERE 1",[objServiceManagementData.dataTypeArray objectAtIndex:0]]:-1];
            objServiceManagementData.taskListArray = [objServiceManagementData fetchDataFrmSqlite:_qryStr :objServiceManagementData.serviceReportsDB :@"SO" :1];
            _updateStatus = FALSE;
    ...
    /*
     ...
     //Delete if any rejected SO in service order table
     NSString *soDltQry = [NSString stringWithFormat:@"DELETE FROM '%@' WHERE OBJECT_ID='%@' AND STATUS='RJCT'",
     [objServiceManagementData.dataTypeArray objectAtIndex:0],
     [objServiceManagementData.taskDataDictionary objectForKey:@"OBJECT_ID"]];
     //[objServiceManagementData deleteDataFromServiceManagmentDB:soDltQry];
...
//calling function to update in SAP as well as sqlite
-(void)cancelDefaultAlertAndCallSAPUpdate
{
	...
	//{
        ...
        //Creating datatype of service confirmation
        NSString *strPar4 = [NSString stringWithFormat:@"%@", @"DATA-TYPE[.]ZGSXSMST_SRVCDCMNT21[.]OBJECT_ID[.]PROCESS_TYPE[.]ZZKEYDATE[.]STATUS[.]STATUS_REASON[.]TIMEZONE_FROM[.]ZZETADATE[.]ZZETATIME"];
		...
		if (statusStr == @"ACPT") {
            ...
            sqlQuery= [NSString stringWithFormat:@"UPDATE '%@' SET ZZKEYDATE='%@', STATUS='%@', ZZETADATE='%@', ZZETATIME='%@'  WHERE OBJECT_ID='%@' ",
             [objServiceManagementData.dataTypeArray objectAtIndex:0],
             [objCurrentDateTime convertMMMDDformattoyyyMMdd:[objServiceManagementData.taskDataDictionary objectForKey:@"ZZKEYDATE"]],
             statusStr,
             [objCurrentDateTime convertMMMDDformattoyyyMMdd:[objServiceManagementData.taskDataDictionary objectForKey:@"ZZETADATE"]],
        ...
        else if(statusStr == @"RJCT")
        {
            ...
            sqlQuery= [NSString stringWithFormat:@"UPDATE '%@' SET ZZKEYDATE='%@', STATUS='%@', STATUS_REASON='%@' WHERE OBJECT_ID='%@' ",
                       [objServiceManagementData.dataTypeArray objectAtIndex:0],
                       [objCurrentDateTime convertMMMDDformattoyyyMMdd:[objServiceManagementData.taskDataDictionary objectForKey:@"ZZKEYDATE"]],
                       statusStr,
                       [objServiceManagementData.taskDataDictionary objectForKey:@"STATUS_REASON"],
        ...
        else
        {
            ...
            sqlQuery= [NSString stringWithFormat:@"UPDATE '%@' SET ZZKEYDATE='%@', STATUS='%@' WHERE OBJECT_ID='%@' ",
                       [objServiceManagementData.dataTypeArray objectAtIndex:0],
                       [objCurrentDateTime convertMMMDDformattoyyyMMdd:[objServiceManagementData.taskDataDictionary objectForKey:@"ZZKEYDATE"]],
                       statusStr,
                       [objServiceManagementData.taskDataDictionary objectForKey:@"OBJECT_ID"]];
    ...
    //###################################################################################################
        ...
        event.title     = [objServiceManagementData.taskDataDictionary objectForKey:@"OBJECT_ID"];
    ...
    //###################################################################################################
		...
		if([self updatetaskInSAPServer:sapRequestArray]== true) //Update sqlite DB..
		{			
			...
			if([objServiceManagementData updateTaskList:sqlQuery])
			{
                ...
                //Gathering all the data's in to task list array..after remove all the objects from tasklist array
                [objServiceManagementData fetchAndUpdateTaskList:[NSString stringWithFormat:@"SELECT * FROM '%@' WHERE 1",[objServiceManagementData.dataTypeArray objectAtIndex:0]]:-1];
...
-(BOOL)updatetaskInSAPServer:(NSMutableArray *)sapRequestArray
{
	...
	par4.Cdata = @"DATA-TYPE[.]ZGSXSMST_SRVCDCMNT21[.]OBJECT_ID[.]PROCESS_TYPE[.]ZZKEYDATE[.]STATUS[.]STATUS_REASON[.]TIMEZONE_FROM[.]ZZETADATE[.]ZZETATIME";	
	//par4.Cdata = @"DATA-TYPE[.]ZGSXSMST_SRVCDCMNT21[.]OBJECT_ID[.]PROCESS_TYPE[.]ZZKEYDATE[.]STATUS[.]ZZETADATE[.]ZZETATIME";	
    ...
    for (int rowIndex1=0; rowIndex < [sapRequestArray count]; rowIndex++) {
		Z_GSSMWFM_HNDL_EVNTRQST00Service_ZgssmbssDatarcrd01 *mPara = [[Z_GSSMWFM_HNDL_EVNTRQST00Service_ZgssmbssDatarcrd01 alloc] init];	
        mPara.Cdata = [sapRequestArray objectAtIndex:rowIndex1];
		NSLog(@"sap request array %@",[sapRequestArray objectAtIndex:rowIndex1]);
    ...
    if(![CheckedNetwork connectedToNetwork])
    {
        ...
        [appPasteBoard setString:@"Some data received from servicepro"];
        
        [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"queueprocessor://com.gss.queueprocessor"]];
	...
	{		
		...
		{	
			...
			{		
				...
				{
                    NSLog(@"[childNode2 stringValue]  %@",[childNode2 stringValue]);
	...
	{		
		...
		{				
			...
			{	
				for(CXMLNode *childNode2 in [childNode children])
				{
                    NSLog(@"name %@  stringvalue   %@",[childNode2 name],[childNode2 stringValue]);
					if([[childNode2 name] isEqualToString:@"Message"] && [childNode2 stringValue]!=nil )
					{
						[self.updateResponseMsgArray addObject:[childNode2 stringValue]];						
					}	
                    else if([[childNode2 name] isEqualToString:@"Type"] && [childNode2 stringValue] != nil)
                    {
                        if ([[childNode2 stringValue] isEqualToString:@"S"]) {
                            self.updateSucessFlag = TRUE;
                        }
                        else
                        {
