...
-(IBAction)orderingTask:(id)sender
{
	...
	UIActionSheet *orderTaskActionSheet = [[UIActionSheet alloc]
                                           ...
                                           otherButtonTitles: NSLocalizedString(@"Servic_Orders_ActionSheet_Order_Task_List_Rep", @"")
										   ,nil];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    // CHANGES Made by Biren on 28-02-13
        ...
        [service_Priority setTitle:[NSString stringWithFormat:@"  %@", NSLocalizedString(@"Service_Order_Table_Header_Title_Priority",@"")] forState:UIControlStateNormal];
        ...
        UILabel *Line_B3 = [self Underline_ButtonTitle:service_Priority];
        ...
        [service_Status setTitle:[NSString stringWithFormat:@"  %@", NSLocalizedString(@"Service_Order_Table_Header_Title_Status",@"")] forState:UIControlStateNormal];
        ...
        UILabel *Line_B4 = [self Underline_ButtonTitle:service_Status];
...
-(void)Header_Button_Click_Event_Service_Task:(id)sender
{
    ...
    if([[NSString stringWithFormat:@"  %@",NSLocalizedString(@"Service_Order_Table_Header_Title_CustL",@"")] isEqualToString:buttonName])
    {
        
        [self Menu_ActionSheet_Sorting:5];
    ...
    else
    {
        ...
        [self Menu_ActionSheet_Sorting:6];
        
    }
    
    // CHANGES Made by Biren on 28-02-13
    if ([buttonName isEqualToString:@" PRI"])
    {
        [self Menu_ActionSheet_Sorting:1];
    }
    
    if ([buttonName isEqualToString:@" STAT"])
    {
        [self Menu_ActionSheet_Sorting:2];
    }
    //end
...
- (void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    /*	if([sBar isFirstResponder])
     ...
     [self Menu_ActionSheet_Sorting:buttonIndex];
     } */
