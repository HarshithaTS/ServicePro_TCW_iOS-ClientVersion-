...
-(void) populateTaskDataDic {
    ...
    if ([tempPrtMast count]>0) {
        [objServiceManagementData.taskDataDictionary setObject:[[tempPrtMast objectAtIndex:0] objectForKey:@"PRIORITY_DESCRIPTION"] forKey:@"PRIORITY"];
    ...
    if ([tmpResultArry count] >0) {
        ...
        [objServiceManagementData.taskDataDictionary setObject:[[tmpResultArry objectAtIndex:0] objectForKey:@"ZZRESULT"] forKey:@"ZRESULT"];
        [objServiceManagementData.taskDataDictionary setObject:[[tmpResultArry objectAtIndex:0] objectForKey:@"ZZRESULTTYPE"] forKey:@"ZZRESULTTYPE"];
        ...
        [objServiceManagementData.taskDataDictionary setObject:@"Select Result" forKey:@"ZRESULT"];
        [objServiceManagementData.taskDataDictionary setObject:@"Select Result Text" forKey:@"ZZRESULTTYPE"];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    */
    if(([[objServiceManagementData.taskDataDictionary objectForKey:@"STATUS_ZZSTATUS_POSTSETACTION"] rangeOfString:@"ASK-FOR-REJECTION-REASON"].location != NSNotFound) && (indexPath.row == (19-total_arrayc) || indexPath.row == 6))
        rowHeight = 115.0f;
    else if([[objServiceManagementData.taskDataDictionary objectForKey:@"STATUS_ZZSTATUS_POSTSETACTION"] rangeOfString:@"ASK-FOR-REJECTION-REASON"].location != NSNotFound && indexPath.row == 11)
        rowHeight = 115.0f;
    else if([[objServiceManagementData.taskDataDictionary objectForKey:@"STATUS_ZZSTATUS_POSTSETACTION"] rangeOfString:@"ASK-FOR-ETA"].location != NSNotFound && indexPath.row == (18-total_arrayc))
        rowHeight = 115.0f;
    else if([[objServiceManagementData.taskDataDictionary objectForKey:@"STATUS_ZZSTATUS_POSTSETACTION"] rangeOfString:@"ASK-FOR-ETA"].location != NSNotFound && indexPath.row == 10)
        rowHeight = 115.0f;
    else if(!([[objServiceManagementData.taskDataDictionary objectForKey:@"STATUS_ZZSTATUS_POSTSETACTION"] rangeOfString:@"ASK-FOR-ETA"].location != NSNotFound) && !([[objServiceManagementData.taskDataDictionary objectForKey:@"STATUS_ZZSTATUS_POSTSETACTION"] rangeOfString:@"ASK-FOR-REJECTION-REASON"].location != NSNotFound) && indexPath.row == (17-total_arrayc))
        rowHeight = 115.0f;
    else if(indexPath.row == 0 && !(errStatus))
        rowHeight = 115.0f;
    else if(indexPath.row == 0 && (errStatus))
        rowHeight = 170.0f;
    else if (( [[objServiceManagementData.taskDataDictionary objectForKey:@"STATUS_ZZSTATUS_POSTSETACTION"] rangeOfString:@"ASK-FOR-REJECTION-REASON"].location == NSNotFound && [[objServiceManagementData.taskDataDictionary objectForKey:@"STATUS_ZZSTATUS_POSTSETACTION"] rangeOfString:@"ASK-FOR-ETA"].location == NSNotFound ) && indexPath.row == 9)
        rowHeight = 115.0f;
    else
        rowHeight = 45.0f;
...
//            cell.backgroundColor = [UIColor colorWithRed:225.0/255 green:241.0/255 blue:255.0/255 alpha:1.0];
        ...
        if ([[objServiceManagementData.taskDataDictionary objectForKey:@"STATUS_ZZSTATUS_POSTSETACTION"] rangeOfString:@"ASK-FOR-ETA"].location != NSNotFound && row_index == 14)
            cell.backgroundColor = [UIColor colorWithRed:225.0/255 green:241.0/255 blue:255.0/255 alpha:1.0];
        ...
        if (flag == 0)
        {
			...
			switch (total_count) {
                ...
                case 9:
                    ...
                    self.contract_value = [Design textFieldFormation:188.0 :5.0 :200.0  :37.0 :2 :self];
...
//            statusStr = @"OPEN";
        ...
        NSString *strPar6 = [NSString stringWithFormat:@"%@", @"DATA-TYPE[.]YTCCSMST_SRVCDCMNT20[.]OBJECT_ID[.]PROCESS_TYPE[.]NUMBER_EXT[.]ZZRESULT[.]ZZRESULTTYPE[.]ZZCONTRACT_VALUE"];
        ...
        NSString *strPar7 = [NSString stringWithFormat:@"YTCCSMST_SRVCDCMNT20[.]%@[.]%@[.]%@[.]%@[.]%@[.]%@",
                   ...
                   ZZRESULT,
                   ZZRESULTTYPE,
                   [objServiceManagementData.taskDataDictionary objectForKey:@"ZZCONTRACT_VALUE"]];

        _soRsltUpdateQry= [NSString stringWithFormat:@"UPDATE '%@' SET ZZRESULT='%@', ZZRESULTTYPE='%@',ZZCONTRACT_VALUE='%@' WHERE OBJECT_ID='%@' AND NUMBER_EXT = '%@'",
...
/*        if (delegate.localSignFilePath !=nil) {
        ...
        if (_updateStatus){
            ...
            if([objServiceManagementData excuteSqliteQryString:_soUpdateQry:objServiceManagementData.serviceReportsDB:@"UPDATE TASK":1]){
                if([objServiceManagementData excuteSqliteQryString:_soRsltUpdateQry:objServiceManagementData.serviceReportsDB:@"UPDATE TASK":1]) {
