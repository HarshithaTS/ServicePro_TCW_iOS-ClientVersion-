...
@interface ServiceOrders : UIViewController <UIActionSheetDelegate, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate,UITextViewDelegate,UINavigationControllerDelegate, UIImagePickerControllerDelegate,MFMailComposeViewControllerDelegate> {
...
@property (nonatomic, retain) UIButton *service_H_StartDate;
@property (nonatomic, retain) UIButton *service_H_CustL;
@property (nonatomic, retain) UIButton *service_H_EstA;
...
@property (nonatomic, retain) UIButton *service_Priority;
@property (nonatomic, retain) UIButton *service_Status;
//end
...
@property (nonatomic,retain) IBOutlet UIActivityIndicatorView *activity_inc;
