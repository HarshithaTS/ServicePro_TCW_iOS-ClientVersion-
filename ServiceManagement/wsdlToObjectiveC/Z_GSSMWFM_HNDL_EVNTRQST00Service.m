...
+ (Z_GSSMWFM_HNDL_EVNTRQST00Binding *)Z_GSSMWFM_HNDL_EVNTRQST00Binding
{
    ...
    return [[[Z_GSSMWFM_HNDL_EVNTRQST00Binding alloc] initWithAddress:objAppDelegate_iPHone.service_url] autorelease];
    
    /*TCW QA
     return [[[Z_GSSMWFM_HNDL_EVNTRQST00Binding alloc] initWithAddress:@"http://TCW-MAS02.ThompsonCreek.com:8200/sap/bc/srt/rfc/sap/z_gssmwfm_hndl_evntrqst00/200/z_gssmwfm_hndl_evntrqst00/z_gssmwfm_hndl_evntrqst00_bndng"] autorelease];
    
    TCW PRODUCTION
    return [[[Z_GSSMWFM_HNDL_EVNTRQST00Binding alloc] initWithAddress:@"http://TCW-MAS01.ThompsonCreek.com:8300/sap/bc/srt/rfc/sap/z_gssmwfm_hndl_evntrqst00/300/z_gssmwfm_hndl_evntrqst00/z_gssmwfm_hndl_evntrqst00"] autorelease];
